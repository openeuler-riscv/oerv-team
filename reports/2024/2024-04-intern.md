...
- 本月尝试了mugen测试，虽然完成的不是特别多，但是学到了很多东西，也感觉这部分工作更适合我
- 本来以为这个月时间多一些能多些产出，结果杂七杂八的事情还是导致我不能专心，不过比之前强一些
- 看到了大家的产出，我还有很长一段路要走

### 外部可见交付

- QA
  - https://gitee.com/src-openeuler/derby/issues/I9KSRP?from=project-issue
  - https://gitee.com/src-openeuler/cachefilesd/issues/I9K6LF?from=project-issue
  - https://gitee.com/src-openeuler/dejagnu/issues/I9K24Y
  - https://gitee.com/src-openeuler/iSulad/issues/I9K5YU?from=project-issue
  - https://github.com/openEuler-RISCV/oerv-team/issues/753 只完成了测试的工作
- 调研工作
  - [调研dmidecode对riscv的支持情况 · Issue #428 · openEuler-RISCV/oerv-team (github.com)](https://github.com/openEuler-RISCV/oerv-team/issues/428)

- 生态探索
  - [milkv 256duo初品 - 掘金 (juejin.cn)](https://juejin.cn/post/7355829021311238182)

### 未来计划

- 更多的接触riscv生态
- 提交一些case或者做一些分享
- 参与 linux kernel 6.6 同源计划 
...
### 感悟思考
- 本月由于自己的病情状况，没能专注的投入到工作中，尝试接下了一个enhancement等级的work，向上游提交了bug report，让我直面了开源工作领域的复杂性：会连续几天毫无头绪，不断重复测试，查阅相关的文档和资料，阅读大部头的技术书籍发掘对自己有用的信息。同时继续跟进了上个月的递归修复工作，解决了maintainer提出的相关issue

### 外部可见交付
- https://gitee.com/src-openeuler/system-config-printer/pulls/66
- [调研解决debugedit测试失败](https://github.com/openEuler-RISCV/oerv-team/issues/283)

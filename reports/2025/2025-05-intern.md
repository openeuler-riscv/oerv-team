...
| 关联 issue 链接 | Issue 类型和简介（如修复xxx，升级xxx） | 外部 PR 或相关工程链接 | 是否关闭 issue 及未关闭 issue 原因 | mentor 评价（本月可以没有） |
| --------------- | -------------------------------------- | ---------------------- | ---------------------------------- | -------------------------- |
| [issue1843](https://github.com/openeuler-riscv/oerv-team/issues/1843) | oerv_24.03SP2 特性测试-桌面测试，补齐桌面场景在该版本上的测试记录 | N/A | 是 | N/A |
...
| [1110](https://github.com/openeuler-riscv/oerv-team/issues/1110) | mugen_LLVM_2409 相关用例修复                        |                                              | 是                                 |                             |
| [1140](https://github.com/openeuler-riscv/oerv-team/issues/1140) | mugen_LLVM_2409 相关失败项处理                        |                                              | 是                                 |                             |
| [1159](https://github.com/openeuler-riscv/oerv-team/issues/1159) | mugen_LLVM_2409 相关问题收敛                        |                                              | 是                                 |                             |
| [1163](https://github.com/openeuler-riscv/oerv-team/issues/1163) | mugen_LLVM_2409 相关自动化问题修复                        |                                              | 是                                 |                             |
| [1194](https://github.com/openeuler-riscv/oerv-team/issues/1194) | mugen_LLVM_2409 相关用例修复                        |                                              | 是                                 |                             |
| [1204](https://github.com/openeuler-riscv/oerv-team/issues/1204) | mugen_LLVM_2409 相关失败项处理                        |                                              | 是                                 |                             |
| [1221](https://github.com/openeuler-riscv/oerv-team/issues/1221) | mugen_LLVM_2409 相关问题收敛                        |                                              | 是                                 |                             |
| [1245](https://github.com/openeuler-riscv/oerv-team/issues/1245) | mugen_LLVM_2409 相关自动化问题修复                        | https://gitee.com/openeuler/mugen/pulls/4179 | 是                                 |                             |
| [1246](https://github.com/openeuler-riscv/oerv-team/issues/1246) | mugen_LLVM_2409 相关用例修复                        |                                              | 是                                 |                             |
| [1249](https://github.com/openeuler-riscv/oerv-team/issues/1249) | mugen_LLVM_2409 相关失败项处理                        |                                              | 是                                 |                             |
| [1282](https://github.com/openeuler-riscv/oerv-team/issues/1282) | mugen_LLVM_2409 相关问题收敛                        |                                              | 是                                 |                             |
| [1286](https://github.com/openeuler-riscv/oerv-team/issues/1286) | mugen_LLVM_2409 相关自动化问题修复                        |                                              | 是                                 |                             |
...
本月同时处理双周报、欧洲峰会专题和前端页面调整。运营侧把活动预热、会中材料归并、会后回顾和双周报连续做了一轮，前端侧则集中在两级 tab、主板详情页和搜索栏筛选上，对“技术内容怎么转成对外稿件”和“页面信息怎么排得更清楚”都有了更具体的经验。

### 外部可见交付

- 完成《2025 欧洲峰会丨OERV 团队参加 2025 RISC-V 欧洲峰会活动预告》推送，从官网 poster 信息中提炼软件所相关内容，重做预热稿样式并完成定时发送与社群扩散。[推送链接](https://mp.weixin.qq.com/s/uNnpQzKaiFoNcYmEEgKJ0A)
- 完成 `OERV 双周报：020 期 - 20250515` 和 `OERV 双周报：021 期 - 20250528` 两期推送，覆盖会前预热、议题邀请、双周会主持、会议纪要整理、正文提炼、排版修订和群内转发，这条流程在本月已经比较稳定。[020](https://mp.weixin.qq.com/s/xQ1s_QZNjRpECJZvAZ2elA) [021](https://mp.weixin.qq.com/s/wqQQKAH1thShg0GKyg12Lg)
- 完成《2025 欧洲峰会丨OERV 团队参加 2025 RISC-V 欧洲峰会会议回顾》推送，对演讲和 poster 摘要重新组织结构，多轮修订后形成面向外部读者的回顾稿。[推送链接](https://mp.weixin.qq.com/s/4M6uKDRSyJlm3TKmPyID-g)
- 同步整理欧洲峰会出行物料表、OERV 近期重要成果清单，并开始准备 LaTeX 海报模板，把峰会物料和后续专题稿常用底稿先收拢起来。[成果整理链接](https://pad.251.sh/IFmApJUqTj6pIIRdJZSv_g)
- 完成《openEuler RVA23 & 香山昆明湖处理器，LLVM 平行宇宙实验版本内测成功》推送排版并形成待发稿件，提前把专题稿样式和版面结构跑通。
- 优化镜像发布页面的上下两级 tab 按钮样式，使上下 tab 可以采用不同风格并左侧对齐，便于区分筛选层级和当前选中状态。[issue #42](https://github.com/openeuler-riscv/imagepub-web/issues/42) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/434b1a093461ccbcc9ba8bc466e9d739e594be0c)
- 调整主板详情页面，把版本列表上方内容前置到筛选列表之前，并对上下 tab 的下划线与样式顺序做了重新组织，让主板信息和版本列表之间的阅读顺序更自然。[issue #52](https://github.com/openeuler-riscv/imagepub-web/issues/52) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/64c2501ce54dbc17595cf166d1725ce520e438a2)
- 继续处理搜索栏相关调整，围绕 ISA 基线筛选参考内核版本拆分子选项，并探索一级搜索按钮、二级搜索按钮的对齐方式；由于新数据进入，ISA 基线筛选仍在继续修正。[issue #63](https://github.com/openeuler-riscv/imagepub-web/issues/63) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/3fab313135af4dd3a983caaa26e327d6546cd0f9)
- 按时参与前端小组周例会，和组内成员一起讨论样式优化方案；本月对 tab、详情页和筛选栏的修改明显提升了页面多端显示和组件交互细节。

### 正在进行的尝试/未来的计划

- 继续整理峰会专题和双周报的常用模板，把样式、物料和成稿流程收成更顺手的固定做法。
- 继续完善筛选栏与 tab 组件的交互细节，后续可以把本月的样式调整沉淀成可复用组件。

## 崇鹏豪

### 感悟思考

本月主要围绕前端国际化、镜像文件列表页和页面细节修复推进。整体工作已经从单页样式重构进入到“镜像列表、帮助文档、历史版本、语言切换”组合起来的页面链路，公共测试站点也可以直接验证这些改动：[http://39.100.90.48/home?lang=zh_CN](http://39.100.90.48/home?lang=zh_CN)。

### 外部可见交付

- 修复中英文切换后搜索框长度变化、搜索图标不居中等问题，保证语言切换后搜索区域仍然保持稳定布局。[issue #62](https://github.com/openeuler-riscv/imagepub-web/issues/62) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/96a66dec56328a7f0b722020c73a6412be899341) [在线验证](http://39.100.90.48/image/v2/zh_CN/products/sipeed/licheepi_4a.json/openEuler/24.03-LTS-SP1/2025-01-02?lang=zh_CN)
- 集中修复详情页现存问题，包括大显示器宽度下卡片高度跳动、详情页版本字体和字号、多语言英文模式下筛选列表不对齐、镜像文件显示完整 http 地址等细节。[issue #56](https://github.com/openeuler-riscv/imagepub-web/issues/56) [commit 1](https://github.com/openeuler-riscv/imagepub-web/commit/16aa99322f15a410889e3a0e003c8deb9cf3fe2a) [commit 2](https://github.com/openeuler-riscv/imagepub-web/commit/0cb5518f190ba0a374ad6560d6b8559750a21870) [commit 3](https://github.com/openeuler-riscv/imagepub-web/commit/da66cc2e521281817135903657120487640d20f0) [commit 4](https://github.com/openeuler-riscv/imagepub-web/commit/1951d3ba78dc197975d86b62289ede11a7bd5071) [在线验证](http://39.100.90.48/board/v2/zh_CN/products/milkv/pioneer.json?lang=zh_CN)
- 开发镜像文件列表页，用户从板卡详情页点击某个历史版本后可以进入镜像文件列表页；页面包含镜像文件下载、帮助文档展示、顶部返回组件复用，以及一个版本对应多个文档和一系列镜像文件时的展示折叠思路。[issue #44](https://github.com/openeuler-riscv/imagepub-web/issues/44) [commit 1](https://github.com/openeuler-riscv/imagepub-web/commit/a4ddd1b7c647068d8d811e68e7a31a71497b88ee) [commit 2](https://github.com/openeuler-riscv/imagepub-web/commit/0811e4cc1174e70c0f90e87a8706c4708f94ee14) [commit 3](https://github.com/openeuler-riscv/imagepub-web/commit/bfe4b453c68864d3be9625e192e84fe41fbac1a2) [在线验证](http://39.100.90.48/image/v2/zh_CN/products/sipeed/licheepi_4a.json/openEuler/24.03-LTS-SP1/2025-01-02?lang=zh_CN)
- 调整筛选结果页，使具体版本可以展示历史版本 changelog，并从版本项跳转到帮助文档和镜像下载页面，解决“筛选结果只有一个版本”的信息不足问题。[issue #43](https://github.com/openeuler-riscv/imagepub-web/issues/43) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/86ff0fad03f050448a7e1913f0625baf01778c42) [在线验证](http://39.100.90.48/board/v2/zh_CN/products/milkv/pioneer.json?lang=zh_CN)
- 推进 i18n 国际化多语言支持，在网站顶部增加语言切换入口，基于 Vue I18n 梳理静态文本到 `locales.js`，并通过变量渲染不同语言版本。[issue #37](https://github.com/openeuler-riscv/imagepub-web/issues/37) [commit 1](https://github.com/openeuler-riscv/imagepub-web/commit/50a12caa8b3b084f68f67e62e25637251e34470b) [commit 2](https://github.com/openeuler-riscv/imagepub-web/commit/81c7bd28c5289704d6e4ea4af09edb58600ecb5c) [在线验证](http://39.100.90.48/board/v2/zh_CN/products/milkv/pioneer.json?lang=en_US)
- 将镜像页面返回按钮从“回首页”调整为“上一页”，并修复相关返回逻辑和镜像页面背景色遮挡问题。[issue #68](https://github.com/openeuler-riscv/imagepub-web/issues/68) [commit 1](https://github.com/openeuler-riscv/imagepub-web/commit/3533d01a73571727171a7d8bbcba514665012cdf) [commit 2](https://github.com/openeuler-riscv/imagepub-web/commit/96a66dec56328a7f0b722020c73a6412be899341)
- 继续做任务拆解、周例会沟通和任务分配，并协助推进统一 URL 参数管理与 RESTful 风格改造。[issue #69](https://github.com/openeuler-riscv/imagepub-web/issues/69) [commit](https://github.com/openeuler-riscv/imagepub-web/commit/d0e75baa0361a7c3fee72a5949b19e1293ec9fd1)

### 正在进行的尝试/未来的计划

- 继续补细节测试和页面功能完善，在拿到测试数据后第一时间验证镜像页、历史版本页、多语言和返回逻辑。
- 尝试用 CSS 新特性提升适配效率，并把本月国际化、镜像页重构中的经验同步给小组成员，减少后续重复踩坑。

## 张超阳

### 感悟思考

本月主要做移动端适配、DarkMode 和状态保持。详情页手机端适配解决的是小屏幕可读性和操作性问题，DarkMode 则需要把全局颜色变量、用户交互和浏览器主题配置串起来，整体覆盖了样式、状态管理和多端体验几个层面。

### 外部可见交付

- 优化详情页面手机端适配，使板卡详情页可以随窗口变化响应布局；同时补充主板描述文字，并调整筛选条件按钮颜色、悬浮动态位置等细节。[issue #41](https://github.com/openeuler-riscv/imagepub-web/issues/41) [PR #50](https://github.com/openeuler-riscv/imagepub-web/pull/50) [PR #47](https://github.com/openeuler-riscv/imagepub-web/pull/47)
- 完成 DarkMode 支持，在网站顶部增加深色/浅色主题切换入口，并通过在 `<html>` 上添加 `.dark` 类结合 CSS 变量完成全局主题切换。[issue #35](https://github.com/openeuler-riscv/imagepub-web/issues/35) [PR #59](https://github.com/openeuler-riscv/imagepub-web/pull/59) [PR #60](https://github.com/openeuler-riscv/imagepub-web/pull/60) [PR #61](https://github.com/openeuler-riscv/imagepub-web/pull/61) [PR #67](https://github.com/openeuler-riscv/imagepub-web/pull/67)
- 梳理 `variables.css` 和 `theme.css` 两套颜色变量，默认浅色模式和 `.dark` 作用域下分别维护对应配色；页面中统一使用 `var(--bg-color)`、`var(--text-color)` 等变量，让主题切换不依赖逐处硬编码颜色。
- 处理 darkmode 和多语言首页刷新后不保持的问题：DarkMode 状态通过 `.dark` 类和本地缓存持久化，多语言通过可选 URL 参数、cookies 和浏览器默认语言逐级回退，保证刷新后页面状态保持一致。[issue #70](https://github.com/openeuler-riscv/imagepub-web/issues/70) [PR #71](https://github.com/openeuler-riscv/imagepub-web/pull/71)
- 继续修复 darkmode 开发中暴露的问题和移动端适配中的细节问题，并通过每周例会同步上周 bug、下一步开发方向和页面调整方案。

### 正在进行的尝试/未来的计划

- 继续提炼全局状态管理和复杂交互的实现经验，把移动端、主题切换和多语言状态保持这几类问题整理成后续开发可复用的处理方式。
...
5月已经回到学校，微调ToyOS进行内核的各种测试，完成毕业设计并准备论文答辩。

### 外部可见交付

| 关联 issue 链接                                              | Issue 类型和简介（如修复xxx，升级xxx）                      | 外部 PR 或相关工程链接                                       | 是否关闭 issue 及未关闭 issue 原因 | mentor 评价（本月可以没有） |
| ------------------------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------- | --------------------------- |
| [issue](https://github.com/openeuler-riscv/oerv-team/issues/1606) | 添加最后一个测试项目sha256sum哈希校验                       | [pr](https://gitee.com/April_Zhao/osmts/commit/7e9f9b4f10f842eb7bf182de94472aa7e726ebaf) | 是                                 | 无                          |
| 无                                                           | 在海量mugen测试中寻找一键运行并总结的方法，一个自我挑战项目 | [项目地址](https://gitee.com/April_Zhao/mugen_run_clean_batch) | 无issue                            | 无                          |

### 正在进行的尝试/未来的计划

跟着新项目边写边学习运维，再专精一下技术，回家考研，等待机会。
...
- 主线分支方面，拉取最新更改并同步主线更新近况，围绕滚动更新最小集完成首批 100 个软件包的补齐。
- 本轮新增软件包主要覆盖核心包、定义文件、构建系统、编译器、C 语言运行时、系统基础工具、压缩组件、包管理器和编程语言支持库。代表性软件包包括 `aaa_base`、`bash`、`cmake`、`gcc/gcc14/gcc15`、`glibc`、`libarchive`、`ncurses`、`openssl-3`、`perl`、`python312`、`readline`、`rpm`、`systemd`、`util-linux`、`zlib` 和 `zstd` 等。
- 搭建一套并行的 OBS 设施，尝试对滚动更新最小集进行自举构建，并完成 GCC、LLVM 与 Python 并行版本的提交与切换，为后续多版本并存和并行构建验证做准备。
- 当前软件包范围已基本覆盖 LFS 要求的基础组件，后续将在此基础上继续启用更完整的服务器功能。
- 参与开源之夏相关社区活动，准备项目宣讲和答疑内容，完成面向 RV/QA SIG 的项目宣讲，并持续回复学生咨询。

### 社区协作与会议

本月的社区协作一方面服务于滚动更新工程，另一方面也围绕开源之夏和发布管理展开。`2025-05-08` 与 `2025-05-22` 两次 SIG-RISC-V 双周例会继续同步滚动更新进展，`2025-05-13` 和 `2025-05-27` 的 Compiler SIG 双周例会分别跟进编译器相关问题和 JDK 升级议题。`2025-05-14` 与 `2025-05-28` 的 TC 双周例会重点讨论二进制提交方式和 RV-SIG 等例行审视事项，`2025-05-16` 与 `2025-05-30` 的 Release Management 例会则分别同步发布管理进展和 openEuler Intelligence 相关能力。

开源之夏相关沟通在本月占比也较高。`2025-05-15` 的 RV/QA SIG 活动中完成了项目宣讲和方向说明，随后继续结合学生咨询和社区需求推进答疑与信息整理。专项协作方面，`2025-05-12`、`2025-05-19`、`2025-05-26` 的前端小组会议主要用于对齐阶段性设计和实现要求，`2025-05-16` 的 OERV-Infra 会议则集中同步 EBS 现况并梳理待处理问题，为后续并行构建和基础设施调整提供支撑。

### 正在进行的尝试/未来的计划

- 在当前最小集基础上继续扩充软件包范围，逐步启用符合 openEuler 需求的更多功能。
- 继续完善并行构建和自举流程，提升滚动分支工程的可维护性与构建效率。
- 继续围绕社区项目宣讲、答疑和需求收集，完善后续协作支撑。

...
因为个人原因决定结束 OERV 的实习，在 OERV 的这么长时间里我接触了很多知识，学到了很多东西，但正因为获得了太多，我再也没办法以这样颓废的状态再待在团队里。我需要做出改变，一次能真的影响自己的改变。各位老师都很好，同学们也都能和友善的交流问题，我看到了大家都在为开源事业而努力着。感谢的话语是说不完的，老师们给了我很多的帮助，并且这种帮助将会持续影响我，也希望有天我可以帮到其他人。如果你是新来的同学看到了这部分，我想要说的是，我在 OERV 实习工作的这段时间里收获很大，是我绝不会忘记的一段经历。在这里我祝愿 OERV 越来越好，也希望各位老师同学生活工作都能顺利。我依然会关注 OERV 的新闻 ，希望我们以后可以走上更大的舞台。
...
### 感悟思考
六月 + 七月共出勤 22 天。做了 etmem ，学习了 rv 下的虚拟机二级页表转换机制，在做 aia 的过程中体会了 rv 下的中断演进的发展过程，从简到繁，发现 aia 和 iommu 这些特性都能与性能化结合起来
...
本月中国峰会相关稿件比较密集，活动预告、现场素材整理、会后回顾和专题稿都完整跑了一轮，模板复用和多人协同修改比前几个月顺了很多。

### 外部可见交付

- 完成《算能正式加入 openEuler 社区，推动高性能 RISC-V 生态繁荣发展》转载推送的排版、简介整理和转载对接。[推送链接](https://mp.weixin.qq.com/s/Zngu2b6z6sB8r4ilBnR2Qg)
- 完成 `OERV 双周报：024 期 - 20250722`，覆盖会前预热、议题邀请、双周会主持、会议纪要整理、正文提炼、排版和群内同步。[推送链接](https://mp.weixin.qq.com/s/HhZ4zkBlBgLeRHpOrx4LFQ)
- 完成《2025 中国峰会丨OERV 团队参加 2025 RISC-V 中国峰会活动预告》推送，从官网收拢 OERV 团队参会信息，并为峰会相关内容单独做了一套可复用模板。[推送链接](https://mp.weixin.qq.com/s/BSc3VC5Z-yXBfWZZHWbunA)
- 完成《openEuler for RVA23！中国科学院软件研究所基于 25.03 版本构建标准 RISC-V 服务器试验镜像》推送，根据初稿和配套材料重新分段、补足说明并反复调整版式，是本月信息量最大的一篇稿件。[推送链接](https://mp.weixin.qq.com/s/PMTbZdsL-EbToYq-WZSmzQ)
- 完成《2025 中国峰会丨OERV 团队参加 2025 RISC-V 中国峰会会议回顾》推送，结合现场图片直播素材和会议信息重新组织正文。[推送链接](https://mp.weixin.qq.com/s/PYj3Se7wuDozJDr7ih1Y-Q)
- 同步完成 `GROW 2025：openEuler 深度适配 RVA23，构建 RISC-V 全栈竞争力` 的人物简介、PPT 内容转写、排版和共享稿导出，为后续正式发布保留好底稿。
- 在中国峰会现场补充了摄影素材，并把这套常用模板和修改方式交接给李燕和阮扬帆，后续同类稿件可以直接沿用。
- 配合同步转发知合计算相关推文和开芯院活动推文，补充社区外部传播链路上的转载和扩散工作。
- 参与第 86 次双周会主持记录，并参加 7 月 1 日线下会议，把例会信息、活动信息和峰会专题材料衔接在同一个月度传播节奏里。

### 正在进行的尝试/未来的计划

- 继续把峰会专题稿和双周报模板收拢成固定做法，减少同类活动稿件的重复排版成本。
...
- 完成 `Roadmap for openEuler Operating System Targeting RVA23` 相关 PPT 翻译，把 openEuler 面向 RVA23 的路线图内容整理成便于会议交流和后续材料复用的版本。
- 撰写《2025 中国峰会丨作为 RISC-V 服务器的 openEuler: 挑战和路线图》公众号稿件，围绕 RISC-V 服务器场景下 openEuler 的挑战、路线图和后续推进方向组织正文，并承接前期峰会模板，让专题内容和本月中国峰会系列稿保持一致的版式与阅读节奏。[推送链接](https://mp.weixin.qq.com/s/iShgFmz3JcbpQP6YZKg_Qg)

### 正在进行的尝试/未来的计划

- 继续沉淀技术会议材料翻译和峰会专题稿撰写经验，后续同类路线图材料可以更快转成对外稿件。
...
| 关联 issue 链接                                              | Issue 类型和简介（如修复xxx，升级xxx）                       | 外部 PR 或相关工程链接                                       | 是否关闭 issue 及未关闭 issue 原因 | mentor 评价（本月可以没有） |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------------------- | --------------------------- |
| [软件包版本收集 · Issue #1965 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1965) | 收集 oerv2403sp2 软件包的版本信息，给后续版本比对先打一个底                              |                                                              | 否，老师还没有review               |                             |
| [RVA23 QEMU镜像网络问题排查](https://github.com/openeuler-riscv/oerv-team/issues/1963) | RVA23 QEMU 镜像网络问题排查，把网络侧异常先定位清楚                                   |                                                              | 是                                 |                             |
| [发布如何安装 openEuler RISC-V 的教程 · Issue #1953 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1953) | 在社区发布 qemu 启动 oe 的教程，把启动流程和注意点整理成公开文档                                   | https://ruyisdk.cn/t/topic/366                               | 是                                 |                             |
| [测试 FUSE passthrough · Issue #1947 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1947) | 内核开启 fuse passthrough 功能进行测试，确认该功能在当前环境下的表现                         |                                                              | 是                                 |                             |
| [分析解决 pango 软件包安装后 nototools 无法调用的问题 · Issue #1945 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1945) | 对 pango 软件包兼容性升级，并向上游提交 issue 和 PR，把问题链条补完整                   | https://gitee.com/src-openeuler/nototools/pulls/17<br />https://gitee.com/src-openeuler/nototools/pulls/18<br />https://github.com/notofonts/nototools/issues/912<br />https://github.com/notofonts/nototools/pull/913 | 是                                 |                             |
| [RISCV架构容器在 docker:dind 容器中运行 · Issue #1762 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1762) | 让 oe 系统支持开机以后可以直接运行 riscv 容器，验证容器链路在系统启动后的可用性                  |                                                              | 否，老师还没有review               |                             |
| [在 24.03 SP1 上测试 secPaver · Issue #1773 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1773) | go 版本升级后验证 secPaver 功能和补丁效果，确认软件包可以正常使用 | https://gitee.com/src-openeuler/secpaver/pulls/58            | 否，pr已合并，老师还没有review     |                             |
| [修复 master 的 containernetworking-plugins，验证补丁在 oe2509 上的构建可用性 · Issue #1892 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1892) | 修复软件包，关注pr动态，测试补丁在oe2509构建可用性，         | https://gitee.com/src-openeuler/containernetworking-plugins/pulls/55 | 是                                 |                             |
| [[工程类需求\] 软件包构建状态查询及展示看板 项目 · Issue #1669 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1669) | 使用 osc 工具获取工程需要的数据，把看板依赖的数据抓取链路先跑通                                | https://github.com/openeuler-riscv/oerv-team/issues/1669#issuecomment-3125051385 | 否                                 |                             |
| [升级 eclipse 到最新版 · Issue #1805 · openeuler-riscv/oerv-team](https://github.com/openeuler-riscv/oerv-team/issues/1805) | 使用 riscv 容器通过 maven 在线构建 eclipse，并摸清运行所需条件  | https://github.com/openeuler-riscv/oerv-team/issues/1805#issuecomment-3125083664 | 否                                 |                             |
...
| 关联 issue 链接 | Issue 类型和简介（如修复xxx，升级xxx） | 外部 PR 或相关工程链接 | 是否关闭 issue 及未关闭 issue 原因 | mentor 评价（本月可以没有） |
| --------------- | -------------------------------------- | ---------------------- | ---------------------------------- | -------------------------- |
|[#1919](https://github.com/openeuler-riscv/oerv-team/issues/1919)| 修复构建失败，处理对应包在当前构建环境下的阻塞 | [PR](https://gitee.com/src-openeuler/kubekey/pulls/30) | 已关闭|无|
|[#1920](https://github.com/openeuler-riscv/oerv-team/issues/1920) | 修复构建失败，处理对应包在当前构建环境下的阻塞 |[PR](https://gitee.com/src-openeuler/prometheus/pulls/25)|已关闭| 无|
| xxHash 提交 CI | 增加 RISC-V 路径上的持续验证 | [PR](https://github.com/Cyan4973/xxHash/pull/1049) | 已合并 | 无 |
| ZSTD 提交 CI，为 RVV 扩展启用加入编译器版本检测 | 把编译器版本判断补进持续验证流程 | [PR](https://github.com/facebook/zstd/pull/4435) | 已合并 | 无 |
...
| 关联 issue 链接    | Issue 类型和简介（如修复xxx，升级xxx） | 外部 PR 或相关工程链接 | 是否关闭 issue 及未关闭 issue 原因 | mentor 评价（本月可以没有） |
| ------------------ | -------------------------------------- | ---------------------- | ---------------------------------- | --------------------------- |
| https://github.com/openeuler-riscv/oerv-team/issues/1959 | 升级社区 dotnet 到 9.0，跟进上游版本切换和社区 review 要求 | https://gitee.com/src-openeuler/dotnet/pulls/11 | 未关闭，社区未review |  |
| 线下坐班天数备注： |                                        |                        |                                    |                             |
...
- 本月继续推进主线分支滚动更新与 RuyiOS 筹备，滚动更新最小集已扩展到 350 个软件包。
- 本轮新增软件包进一步补齐了系统核心组件、C 语言库、Python 与 Perl 支持库、定义文件以及网络与系统管理相关组件。代表性软件包包括 `libX11`、`NetworkManager`、`python-attrs`、`python-pluggy`、`systemd-default-settings`、`libsodium`、`protobuf-c`、`dbus-broker`、`chrony`、`ca-certificates`、`python-pytest`、`python-Pygments`、`doxygen`、`libbpf`、`python-lxml` 和 `polkit` 等。
- 持续关注下一代创新版本的构建状态，为下一个大版本发布准备建议，并整理 openEuler 生命周期现状与前期创新版本的软件包选型情况。
- 完成 RuyiOS 最小验证映像，当前已经可以启动到命令行界面；同时继续讨论系统整体方向，包括 Rust 组件占比、平滑替换路径，以及代码存储和独立构建机器等基础设施准备。
- 在 RISC-V 中国峰会期间验证测试新硬件设备，测试 DP1000 处理器上的内核构建速度，并关注 `rv64.zip` 项目，作为 multilib 方向的替代参考选择。

### 社区协作与会议

本月的社区协作继续覆盖滚动更新、发布管理、软件包治理和版本规划。`2025-07-03` 与 `2025-07-24` 的 SIG-RISC-V 双周例会持续同步滚动更新进展，`2025-07-04` 的 RM 临时例会专门讨论分支拉取策略，`2025-07-11` 和 `2025-07-25` 两次 Release Management 例会则持续跟进创新版构建和发布管理问题。`2025-07-08` 与 `2025-07-22` 的 Compiler SIG 会议继续围绕版本升级和 GCC 升级展开，`2025-07-16` 的 TC 双周例会讨论语言组件软件包衰退问题，同日的 EPKG 例会继续同步软件包更新进展。规范与治理方面，`2025-07-06` 的 SIG-ROS 例会和 `2025-07-10` 的 AI SIG 例会分别进行了大型软件管理规范、多版本管理规范的宣讲，`2025-07-14` 的 Infra 例会则继续同步 OEEP0023 大型套组软件管理规范。

除例行会议外，本月还有几项更偏阶段性的协作节点。`2025-07-30` 的软件包与容器镜像瘦身专项会议集中讨论包和镜像瘦身策略，`2025-07-31` 的 openEuler 技术委员会线下第二次会议则汇报了生命周期现状与相关软件包选型分析。围绕 RuyiOS，`2025-07-06` 继续召开专项会议，同步最小系统映像和基础设施准备情况；`2025-07-16` 至 `2025-07-19` 参加 RISC-V 中国峰会，结合现场调研、硬件验证和社区交流，为后续版本规划、构建机选型和 multilib 替代路径判断补充了一手信息。

### 正在进行的尝试/未来的计划

- 在当前 350 包基础上继续补齐依赖，以较小依赖集合推动最小图形环境启动。
- 继续梳理 openEuler 社区版本生命周期和分支拉取规划，尽量减少因降级带来的额外维护成本。
- 持续推进 RuyiOS 的流畅构建和后续创新功能落地。

### 产出文档

- openEuler 生命周期现状与软件包选型状态（用于 `2025-07-31` TC 线下会议）
